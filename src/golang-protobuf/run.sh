...
docker run  -itd --name golang-protobuf-final-technician-route-planner -v /home/robert/technicianrouteplanner/src/proto:/go/src/golang-protobuf/proto golang-protobuf-final-technician-route-planner
