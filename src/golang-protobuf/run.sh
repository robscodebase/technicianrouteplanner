...
docker run  -itd --name grpc-server-final-technician-route-planner -v /home/robert/technicianrouteplanner/src/proto:/go/src/grpc-server/proto grpc-server-final-technician-route-planner
