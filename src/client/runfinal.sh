...
docker run  -itd --name vue-technician-route-planner -v /home/robert/technicianrouteplanner/src/vue:/vue-technician-route-planner vue-technician-route-planner
