...
docker run  -itd --name vue-technician-route-planner-install -v /home/robert/technicianrouteplanner/vuesrc:/vue-technician-route-planner vue-technician-route-planner-install
